...
import cn.walink.pulltorefresh.library.internal.FlipLoadingLayout;
import cn.walink.pulltorefresh.library.internal.LoadingLayout;
import cn.walink.pulltorefresh.library.internal.RotateLoadingLayout;
import cn.walink.pulltorefresh.library.internal.Utils;
import cn.walink.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected final int getFooterSize() {
        ...
        if (mFooterLayout.getContentSize() == 0) {
            int w = View.MeasureSpec.makeMeasureSpec(0,
                    View.MeasureSpec.UNSPECIFIED);
            int h = View.MeasureSpec.makeMeasureSpec(0,
                    View.MeasureSpec.UNSPECIFIED);
            mFooterLayout.measure(w, h);
            int height = mFooterLayout.getMeasuredHeight();
            int width = mFooterLayout.getMeasuredWidth();
    ...
    protected final int getHeaderSize() {
        ...
        if (mHeaderLayout.getContentSize() == 0) {
            int w = View.MeasureSpec.makeMeasureSpec(0,
                    View.MeasureSpec.UNSPECIFIED);
            int h = View.MeasureSpec.makeMeasureSpec(0,
                    View.MeasureSpec.UNSPECIFIED);
            ...
            int width = mHeaderLayout.getMeasuredWidth();
            ...
            if (mShowViewWhileRefreshing) {
                switch (mCurrentMode) {
                    ...
                    case PULL_FROM_END:
                        ...
                        Log.e("Potato", getFooterSize() + "footSize");
                        break;
                    default:
                    case PULL_FROM_START:
                        Log.e("Potato", getHeaderSize() + "getHeaderSize");
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        ...
        //12月29号添加的异常catch,源代码为:super.onRestoreInstanceState(state);
     try {
