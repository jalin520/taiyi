...
//				R.styleable.WaterWaveProgress_progressColor, 0xFF33B5E5);//边框颜色
                R.styleable.WaterWaveProgress_progressColor, 0xFF4aa328);
        progressBgColor = typedArray.getColor(
                R.styleable.WaterWaveProgress_progressBgColor, 0xFFBEBEBE);
//				R.styleable.WaterWaveProgress_progressBgColor, 0xFF4aa328);//边框背景颜色
        waterWaveColor = typedArray.getColor(
                R.styleable.WaterWaveProgress_waterWaveColor, 0xFF4aa328);
//				R.styleable.WaterWaveProgress_waterWaveColor, 0XFF4BBDFE);//水波颜色
