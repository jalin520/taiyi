...
public class CacheUtils {
    ...
    public static String getCacheDatabaseSize(Context context) throws Exception {
        return StringUtils.formatFileSize(getFolderSize(new File("/data/data/" + context.getPackageManager() + "/databases")));
    }
    ...
    public static String getCacheSharePreferenceSize(Context context) throws Exception {
        return StringUtils.formatFileSize(getFolderSize(new File("/data/data/" + context.getPackageManager() + "/shared_profs")));
    }
